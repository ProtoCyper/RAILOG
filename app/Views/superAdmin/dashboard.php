  ...
  <div class="dashboard-container">
    ...
    <div class="stats-grid">
      ...
      <div class="stat-card">
        ...
        <div class="stat-value"><?= esc($totalAdmin) ?></div>
      </div>

      <!-- Total Admin Aktif -->
      <div class="stat-card">
        <div class="stat-label">Total Admin Aktif</div>
        <div class="stat-value"><?= esc($totalAdminAktif) ?></div>
      </div>
    ...
    <div class="content-grid">
      ...
      <div class="activity-section">
        <div class="section-header">
          ...
          <a href="<?= base_url('superadmin/log-aktivitas-admin') ?>" class="section-link">Lihat Semua</a>
        </div>
        ...
        <div style="text-align: center; margin-top: 1.5rem;">
          <a href="<?= base_url('superadmin/log-aktivitas-admin') ?>" class="view-all-link">Lihat Semua Aktivitas</a>
        </div>
      </div>
    </div>
  </div>
